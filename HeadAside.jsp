...
<head>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_tags"><a href="#">Cadastrar Promoções de Estabelecimento</a></li>
		</ul>
		<h3>Usuários</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="#">Adicionar Novo Usuário</a></li>
			<li class="icn_view_users"><a href="#">Visualizar Usuários</a></li>
